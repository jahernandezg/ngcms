...
@Component({
  ...
  template: `
    <div *ngIf="src; else placeholder" class="relative">
      <img [src]="src" [alt]="alt || 'Imagen del post'" class="rounded-lg shadow max-w-full" />
    </div>
...
export class PostImagePreviewComponent { @Input() src: string | null = null; @Input() alt?: string; }
